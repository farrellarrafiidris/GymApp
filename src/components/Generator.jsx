...
import { SCHEMES, WORKOUTS } from "../utils/main";
...
export default function Generator(props) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="flex flex-col w-[50%] mx-auto lg:w-full lg:grid lg:grid-cols-4 gap-4">
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border-2 duration-200 px-4 hover:border-blue-600 py-3 rounded-lg " +
      ...
      <div className="bg-slate-950 py-3 border border-solid border-blue-400 rounded-lg flex flex-col">
        ...
        >
          <p className="capitalize">{muscles.length == 0 ?  'Select mucle groups' : muscles.join(', ')}</p>
      ...
      />
      <div className="flex flex-col w-[50%] mx-auto lg:w-full lg:grid lg:grid-cols-3 gap-4">
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border-2 duration-200 px-4 hover:border-blue-600 py-3 rounded-lg lg:py-1 " +
